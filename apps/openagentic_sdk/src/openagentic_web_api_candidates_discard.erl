-module(openagentic_web_api_candidates_discard).
...
init(Req0, State0) ->
  ...
  case decode_json(BodyBin) of
    {ok, Obj0} ->
      ...
      case openagentic_case_store:discard_candidate(SessionRoot, Payload) of
        {ok, Candidate} -> reply_json(200, #{candidate => Candidate}, Req1, State);
