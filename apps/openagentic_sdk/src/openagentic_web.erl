...
start(Opts0) ->
  ...
  ok = openagentic_case_scheduler:configure(Opts),
  ...
  Dispatch =
    cowboy_router:compile([
      {'_', [
        ...
        {"/api/cases/:case_id/templates", openagentic_web_api_case_templates, State},
        {"/api/cases/:case_id/templates/:template_id/instantiate", openagentic_web_api_case_template_instantiate, State},
        {"/api/cases/:case_id/tasks/:task_id/detail", openagentic_web_api_tasks_detail, State},
        {"/api/cases/:case_id/tasks/:task_id/run", openagentic_web_api_tasks_run, State},
        ...
        {"/api/cases/:case_id/tasks/:task_id/runs/:run_id/retry", openagentic_web_api_runs_retry, State},
        {"/api/cases/:case_id/observation-packs", openagentic_web_api_observation_packs, State},
        {"/api/cases/:case_id/observation-packs/:pack_id/inspect", openagentic_web_api_observation_pack_inspect, State},
        {"/api/cases/:case_id/observation-packs/:pack_id/reconsideration-packages", openagentic_web_api_reconsideration_packages_create, State},
        {"/api/cases/:case_id/reconsideration-packages/:package_id/preview", openagentic_web_api_reconsideration_package_preview, State},
        {"/api/cases/:case_id/reconsideration-packages/:package_id/:action", openagentic_web_api_reconsideration_package_action, State},
        {"/api/cases/:case_id/mail/:mail_id/:action", openagentic_web_api_case_mail_state, State},
        {"/api/inbox", openagentic_web_api_inbox, State},
        {"/api/inbox/unread-count", openagentic_web_api_inbox_unread_count, State},
