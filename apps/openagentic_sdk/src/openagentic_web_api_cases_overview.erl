-module(openagentic_web_api_cases_overview).
...
init(Req0, State0) ->
  ...
  case openagentic_case_store:get_case_overview(SessionRoot, CaseId) of
    {ok, Overview} -> reply_json(200, Overview, Req0, State);
