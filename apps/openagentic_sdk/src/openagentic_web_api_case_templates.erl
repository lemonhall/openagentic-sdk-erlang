-module(openagentic_web_api_case_templates).
...
init(Req0, State0) ->
  ...
  case Method of
    <<"GET">> ->
      case openagentic_case_store:list_templates(SessionRoot, CaseId) of
        {ok, Templates} -> reply_json(200, #{templates => Templates}, Req0, State);
    ...
    <<"POST">> ->
      ...
      case decode_json(BodyBin) of
        {ok, Obj0} ->
          Payload = (ensure_map(Obj0))#{case_id => CaseId},
          case openagentic_case_store:create_template(SessionRoot, Payload) of
