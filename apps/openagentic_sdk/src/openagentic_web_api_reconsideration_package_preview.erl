-module(openagentic_web_api_reconsideration_package_preview).
...
init(Req0, State0) ->
  ...
  case openagentic_case_store:get_reconsideration_preview(SessionRoot, CaseId, PackageId) of
    {ok, Res} -> reply_json(200, Res, Req0, State);
